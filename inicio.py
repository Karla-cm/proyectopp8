...
if __name__ == "__main__":
    ...
    La Universidad Nacional Rosario Castellanos (UNRC), como institución innovadora y orientada al futuro, rápidamente se posicionó como un centro vital para la formación de profesionales especializados, en particular en áreas como la Ciencia de Datos para Negocios. Sin embargo, con un rápido crecimiento y un enfoque vanguardista, surgió un desafío: la necesidad de un sistema de vinculación laboral que estuviera a la altura de su modelo educativo.<br>
    Los métodos tradicionales de networking y ferias de empleo eran insuficientes para un cuerpo estudiantil y de egresados que domina la analítica avanzada. Se requería una solución que hablara el mismo idioma: el lenguaje de los datos. El proceso de matching entre el talento especializado de la UNRC y las vacantes complejas del sector productivo era lento, manual y carecía de la precisión que solo la IA puede ofrecer.<br><br>
